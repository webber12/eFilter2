...
$tplFilterForm = '
                <form id="eFiltr" class="eFiltr eFiltr_form" action="[+url+]" method="[+form_method+]">
                    ...
                    <div class="eFiltr_btn_wrapper" style="display:none;"><input type="submit" class="eFiltr_btn" value="[+btn_text+]"></div>
                </form>';
...
$tplRowCheckbox = '
<li>
	<label><input type="checkbox" name="f[[+tv_id+]][]" value="[+value+]" [+selected+] [+disabled+]> [+name+] <span class="fltr_count">[+count+]</span></label>
</li>
';
$tplOuterCheckbox = '
<div class="shop-sidebar mb-30 fltr_block fltr_block_checkbox fltr_block[+tv_id+] [+active_block_class+]">
    <h4 class="title fltr_name fltr_name_checkbox fltr_name[+tv_id+]">[+name+]</h4>
...
//слайдер
$tplRowSlider = '
<div style="display:none;">от<input type="text" id="minCostInp[+tv_id+]" name="f[[+tv_id+]][min]" value="[+minval+]" data-min-val="[+minvalcurr+]"> до <input type="text" id="maxCostInp[+tv_id+]" name="f[[+tv_id+]][max]" value="[+maxval+]" data-max-val="[+maxvalcurr+]"></div>
';
$tplOuterSlider = '

<div class="shop-sidebar mb-30 fltr_block fltr_block_slider fltr_block[+tv_id+] [+active_block_class+]">
    ...
    <div class="filter-price-content">
		<div class="fltr_inner fltr_inner_slider fltr_inner[+tv_id+]">
			...
			[+wrapper+]
            <div class="slider_text slider_text[+tv_id+]"><span id="minCost[+tv_id+]"></span> byn — <span id="maxCost[+tv_id+]"></span> byn</div>
		</div>
	</div>
</div>
